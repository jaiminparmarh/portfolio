      ...
      <section className="section">
        ...
        <div className="creative-skills-grid">
          <div className="creative-card">
            <h3> <i className="fa-solid fa-video creative-icon"></i> Video Editing</h3>
            <p>
          ...
          <div className="creative-card">
            <h3><i className="fa-solid fa-image creative-icon"></i> Photo Editing</h3>
            <p>
          ...
          <div className="creative-card">
            <h3><i className="fa-solid fa-headphones creative-icon"></i> Audio Editing</h3>
            <p>
